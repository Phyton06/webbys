  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-8">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-gray-200 pb-5">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Análisis y Métricas del Negocio</h1>
        ...
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            className="rounded-md border border-gray-300 bg-white py-1.5 px-3 text-sm font-medium shadow-sm focus:border-amber-500 focus:outline-none focus:ring-1 focus:ring-amber-500"
          >
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 space-y-4">
        <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-2 border-b border-gray-100 pb-3">
          <div>
            <h2 className="text-lg font-bold text-gray-900">Tendencia de Retención de Clientes</h2>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-3">
              {summary.retention.map((r) => (
                <div key={r.month} className="bg-gray-50 border border-gray-100 rounded-lg p-3 text-center">
                  <span className="text-xs font-semibold text-gray-500 block">{r.month}</span>
                  <span className="text-base font-bold text-amber-600 block mt-1">{r.retained}%</span>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 space-y-4">
        <div className="flex justify-between items-center border-b border-gray-100 pb-3">
          <div>
            <h2 className="text-lg font-bold text-gray-900">Mapa de Calor: Horas Pico</h2>
            <p className="text-xs text-gray-500">
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full text-xs text-center border-collapse">
            ...
            <tbody className="divide-y divide-gray-100">
              {DAYS.map((d) => (
                <tr key={d.key}>
                  <td className="p-2 text-left font-semibold text-gray-800">{d.label}</td>
                  {HOURS.map((h) => {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 space-y-4">
          <div className="border-b border-gray-100 pb-3">
            <h2 className="text-lg font-bold text-gray-900">Valor de Vida del Cliente (LTV)</h2>
            <p className="text-xs text-gray-500">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 space-y-4">
          <div className="border-b border-gray-100 pb-3">
            <h2 className="text-lg font-bold text-gray-900">Servicios Más Solicitados</h2>
            <p className="text-xs text-gray-500">Servicios líderes en volumen de reservas e ingresos generados.</p>
          </div>
              ...
              return (
                <div key={svc.serviceId} className="space-y-1.5">
                  <div className="flex justify-between text-xs font-medium">
                    <span className="text-gray-900 font-semibold">{svc.name}</span>
                    <span className="text-gray-500">
                      {svc.count} citas • <strong className="text-gray-800">${svc.revenue.toLocaleString()}</strong>
                    </span>
                  </div>
