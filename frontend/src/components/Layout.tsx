...
const IconMore = <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M6.75 12a.75.75 0 11-1.5 0 .75.75 0 011.5 0zM12.75 12a.75.75 0 11-1.5 0 .75.75 0 011.5 0zM18.75 12a.75.75 0 11-1.5 0 .75.75 0 011.5 0z" /></svg>
...
const NAV_CONFIG: Record<UserRole, NavItem[]> = {
  ADMIN: [
    ...
    { to: '/admin/mas', label: 'Más', icon: IconMore },
  ],
  BARBER: [
